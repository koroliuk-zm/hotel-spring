...
class UserServiceTest {
	...
	void testFindUserByIdForSavedUser() {
		User savedUser = userRepo.save(new User(100L, "Ivan", "Petrov", "ipetrov", "123456", "ipetrov@gmail.com",
				new UserRole(3, "user"), true));
	...
	@Test
	void testSaveUser() {
		User user = userService.saveUser(new UserDTO(100L, "Ivan", "Petrov", "ipetrov", "123456", "123456",
				"ipetrov@gmail.com", new UserRole(3, "user"), true));
	...
	void testGetAllUsers() {
		...
		userRepo.save(new User(100L, "Ivan", "Petrov", "ipetrov", "123456", "ipetrov@gmail.com",
				new UserRole(3, "user"), true));
		userRepo.save(new User(101L, "Petro", "Demidiv", "pdemidiv", "123456", "pdemidiv@gmail.com",
				new UserRole(3, "user"), true));
		userRepo.save(new User(102L, "Mikhail", "Svets", "msvets", "123456", "msvets@gmail.com",
				new UserRole(3, "user"), true));
	...
	void testUpdateUser() {
		User savedUser = userRepo.save(new User(100L, "Ivan", "Petrov", "ipetrov", "123456", "ipetrov@gmail.com",
				new UserRole(3, "user"), true));
		User updatedUser = userService.updateUser(savedUser.getId(), new UserDTO(100L, "Ivan", "Petrov", "ipetriv",
				"123456", "123456", "ipetrov@gmail.com", new UserRole(3, "user"), true));
