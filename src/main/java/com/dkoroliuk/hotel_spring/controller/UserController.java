...
public class UserController {
	...
	public String userPage(Model model) {
		...
		model.addAttribute("newOrders", requestService.findUsersRequests(getUserById()));
	...
	public String roomOrderPage(@PathVariable Long id, Model model) {
		...
		String message = String.format("User id %s going to order room number %s", getUserById(),
				roomOrderDTO.getRoom().getNumber());
		logger.info(message);
	...
	/**
	 * Method to save new {@link Order}. Handles POST request for URL
	 * "/rooms/order/create_new_order/"
	 * 
	 * @param roomOrderDTO model attribute {@link RoomOrderDTO} for entity
	 *                     {@link Order}
